...
// server.create("series", { name: "John Wick", year: 2014 })
// server.create("series", { name: "The Hunger Games", year: 2012 })
// server.create("series", { name: "Fear Street", year: 2021 })
// server.create("series", { name: "Before Trilogy", year: 1992 })
// server.create("series", { name: "Little Things", year: 2016 })
// server.create("series", { name: "You", year: 2018 })
// server.create("series", { name: "Final Destination", year: 2003 })